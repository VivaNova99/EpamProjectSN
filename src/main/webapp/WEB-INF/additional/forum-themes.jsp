    ...
    <ul>
        <li>
            <ul>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=310"><h3>Наш форум</h3></a></li>
                <li><p>Обсуждение работы форума.
                    Проблемы и их решения</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=320"><h3>Конкурсы</h3></a></li>
                <li><p>Конкурсы для наших форумчан</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=330"><h3>Опросник</h3></a></li>
        ...
        <li>
            <ul>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=203"><h3>Ах, эта свадьба!</h3></a></li>
        ...
        <li>
            <ul>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=105"><h3>Планируем беременность</h3></a></li>
                <li><p>Форум для тех, кто пока не имеет деток,
                    но очень их хочет, а также для тех, кто имеет деток, но им все мало :)</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=110"><h3>Беременность и роды</h3></a></li>
        ...
        <li>
            <ul>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=115"><h3>Детское здоровье</h3></a></li>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=120"><h3>О малышах до года</h3></a></li>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=125"><h3>Развивающие центры, кружки и занятия</h3></a></li>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=130"><h3>Детские сады и ясли</h3></a></li>
                <li><p>Все о Детских садах</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=135"><h3>От года до трех</h3></a></li>
                <li><p>Форум о детях от года до трех лет</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=140"><h3>От трех до шести</h3></a></li>
                <li><p>Форум о детях от 3 до 6 лет</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=145"><h3>Младшие школьники</h3></a></li>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=150"><h3>Подростки</h3></a></li>
                <li><p>Форум для обсуждения проблем и
                    успехов наших детей подростков</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=155"><h3>В десять быть дома!</h3></a></li>
                <li><p>Форум для обсуждения проблем и
        ...
        <li>
            <ul>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=206"><h3>Наш дом</h3></a></li>
                <li><p>Разговоры о ремонте, мебели, быт. технике,
                    экономии, а также уют, проблемы с соседями и прочие бытовые проблемы</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=209"><h3>Все о недвижимости</h3></a></li>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=212"><h3>Тратим деньги</h3></a></li>
                <li><p>Про магазины, торговые центры, удачные и
                    неудачные покупки, распродажи, защита прав потребителей</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=215"><h3>Работа и образование</h3></a></li>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=218"><h3>Бастен бак</h3></a></li>
                <li><p>Что-то стучит в моторе (C).
                    Разговоры об автомобилях и всем, что с ними связано</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=221"><h3>Дачная тематика и загородная жизнь</h3></a></li>
        ...
        <li>
            <ul>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=224"><h3>Lege artis</h3></a></li>
                <li><p>Литература, искусство, история и философия.
                    Фильмы, спектакли, концерты, выставки. Творчество форумчан</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=227"><h3>Кулинария</h3></a></li>
                <li><p>Для тех, кто любит готовить</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=230"><h3>Рукоделие</h3></a></li>
                <li><p>Мастерицам-рукодельницам -
                    обмен опытом и хвастанье произведениями искусства</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=233"><h3>О домашних питомцах</h3></a></li>
                <li><p>Форум о домашних животных.
                    Уход, кормление, лечение и пр.</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=236"><h3>Горшки и корешки</h3></a></li>
                <li><p>Флора. Дома и на даче, своими руками</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=239"><h3>Досуг и отдых (клубы, рестораны, загородный отдых)</h3></li>
                <li><p>Все об отдыхе в Санкт-Петербурге и
                    Ленинградской области: рестораны, клубы, дискотеки, пансионаты, дома отдыха и пр.</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=242"><h3>Hard and soft</h3></a></li>
        ...
        <li>
            <ul>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=245"><h3>Финляндия - столица Швеции (с)</h3></a></li>
                <li><p>Все о Финляндии, Швеции, Норвегии и
                    странах Прибалтики</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=248"><h3>Едем в отпуск</h3></a></li>
                <li><p>Все об организованном отдыхе и
                    поездках по путевкам. Рассказы о путешествиях</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=251"><h3>Я сам</h3></a></li>
        ...
        <li>
            <ul>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=254"><h3>Дом мод</h3></a></li>
                <li><p>Разговоры о моде, стиле, красоте.
                    Обсуждение репортажей, обзоров с fashion-событий</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=257"><h3>Красота - страшная сила!</h3></a></li>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=260"><h3>Наше здоровье</h3></a></li>
                <li><p>Все о нашем здоровье.
                    Обмен опытом, информацией о врачах, больницах и пр.</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=263"><h3>О спорт, ты - жизнь!</h3></a></li>
                <li><p>Физическая культура в массы</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=266"><h3>Похудательный форум</h3></a></li>
        ...
        <li>
            <ul>
                ...
                <li><a href="forum-this-theme?this_forum_theme_order=269"><h3>Женские грезы</h3></a></li>
                <li><p>Если хочется выговориться,
                    поделиться радостью, найти поддержку, похвастаться или просто поразмышлять о жизни :)</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=272"><h3>Развлечения дома</h3></a></li>
                <li><p>Обсуждение просмотренных по TV сериалов
                    и передач. Музыка. Юмор. Игры. Конкурсы. Работы в Photoshop</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=275"><h3>Курилка</h3></a></li>
                <li><p>Мужские разговоры. Про все настоящее мужское.
                    О загадочной мужской душе</p></li>
                <li><a href="forum-this-theme?this_forum_theme_order=278"><h3>Обо всем остальном</h3></a></li>
