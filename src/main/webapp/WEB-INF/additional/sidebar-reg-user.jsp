...
<div class="sidebar-reg-user">
    <ul>
        ...
        <li><a href="user-photoalbums?email=<%=request.getParameter("email")%>&user_id=<%=request.getParameter("user_id")%>"><i class="fa fa-book" aria-hidden="true"></i>Фотоальбомы</a></li>
