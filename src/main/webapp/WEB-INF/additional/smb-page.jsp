    ...
    <%--<textarea class="whats-new" placeholder="Что у Вас нового?"></textarea>--%>
        ...
        <ul class="my-wall">
            ...
            <ul>
                ...
                <li class="link">
                    <a href="forum-this-topic?this_forum_topic_id=<%=last10ForUserWallMessage.getId()%>&email=<%=request.getParameter("email")%>&user_id=<%=request.getParameter("user_id")%>"> ссылка на обсуждение </a>
                </li>
            </ul>
            <%
                }
